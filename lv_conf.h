...
#define DEFAULT_DISP_TYPE   DISP_TYPE_ILI9488//DISP_TYPE_ILI9341
/*----------------
 * Dynamic memory
 *----------------*/
...
#if LV_MEM_CUSTOM == 0
#define LV_MEM_SIZE    (32 * 1024U)        /*Size memory used by `lv_mem_alloc` in bytes (>= 2kB)*/
...
#if DEFAULT_DISP_TYPE==DISP_TYPE_ILI9488
